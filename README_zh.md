...
| 阶段 | 工具 | 说明 |
|------|------|------|
| **找灵感** | 选题灵感 | 输入你的赛道，AI 生成一批带切入角度、内容形式与热度预估的选题 |
| | 对标拆解 | 粘贴爆款内容，拆解它为什么火（钩子/结构/情绪/受众），并按同款套路生成原创草稿 |
| **写文案** | 爆款标题 | 生成一批带吸引力评分与爆款要素标注的候选标题 |
| | 多平台改写 | 一段文案一键改写成小红书 / 抖音 / 公众号 / B站 / 微博风格 |
...
| **排期・复盘** | 内容日历 | 规划各平台发布节奏，管理内容计划与状态，可与创作流程 / 历史记录双向联动 |
| | 数据复盘 | 手动录入已发布数据，查看表现统计并获取 AI 复盘洞察 |
